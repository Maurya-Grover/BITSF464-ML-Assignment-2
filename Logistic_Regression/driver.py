...
for i in range(10):
    ...
    w, b = gradient_descent(x_train, y_train, 0.1, 1000) if (algo == 'GD') else stochastic_gradient_descent(x_train, y_train, 0.1, 250)# if (algo == 'sgd') else print('error'), exit(0))
